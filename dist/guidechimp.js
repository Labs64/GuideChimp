...
function () {
  ...
  (0, _createClass2.default)(GuideChimp, [{
    ...
    value: function setTooltipLayerPosition(tooltipLayer, el) {
      ...
      switch (position) {
        case 'top':
          style.bottom = "".concat(elHeight + padding, "px");
          break;

        case 'right':
          style.left = "".concat(elRight + padding / 2 - root.clientLeft, "px");
          break;

        case 'left':
          style.right = "".concat(root.clientWidth - (elLeft - padding / 2), "px");
          break;

        case 'bottom':
          style.top = "".concat(elHeight + padding, "px");
          break;
      ...
      if (alignment) {
        ...
        switch (alignment) {
          case 'left':
            {
              style.left = "".concat(elLeft - padding / 2, "px");
              break;
            }

          case 'right':
            {
              style.right = "".concat(root.clientWidth - elRight - padding / 2, "px");
              break;
            }
          ...
          default:
            {
              if (elLeft + elWidth / 2 < tooltipWith / 2 || elLeft + elWidth / 2 + tooltipWith / 2 > root.clientWidth) {
                style.left = "".concat(root.clientWidth / 2 - tooltipWith / 2, "px");
              } else {
                style.left = "".concat(elLeft + elWidth / 2 - tooltipWith / 2, "px");
              }
            }
        }
      }
...
var _GuideChimp = _interopRequireDefault(__webpack_require__(/*! ./GuideChimp */ "./src/GuideChimp.js"));
